        ...
        <div class="right-panel">
            <div class="w-100" style="max-width: 400px;">
                <div class="text-center mb-4">
                    <img src="/assets/forget-imagee.png" alt="Forgot Illustration" class="forgot-image"
                        style="width: 180px;">
                ...
                @else
                    ...
                    <form method="POST" action="{{ route('password.otp.step') }}">
                        ...
                        <p class="text-muted text-center mb-3" style="font-size: 0.9rem;">We have sent a verification code
                            to your email</p>

                        <div class="d-flex justify-content-center gap-2 mb-3">
                            @for ($i = 0; $i < 6; $i++)
                                <input type="text" maxlength="1" name="otp[]"
                                    class="otp-input text-center form-control p-2"
                                    style="width: 45px; height: 50px; font-size: 1.5rem;" required>
                            @endfor
                        </div>
