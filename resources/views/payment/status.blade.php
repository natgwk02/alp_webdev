    ...
    <div class="card shadow-sm mb-5">
        <div class="card-body">
            ...
            @if (!empty($status_message))
                <div class="alert 
                    @if ($order->payment_status == 'paid') alert-success
                    @elseif ($order->payment_status == 'pending') alert-warning
                    @elseif ($order->payment_status == 'failed') alert-danger
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="{{ route('payment.status', ['order' => $order]) }}" class="btn btn-outline-secondary">
