                                    ...
                                    <div class="mb-4">
                                        ...
                                        <form id="voucher-form" method="POST" action="{{ route('cart.applyVoucher') }}">
                                            ...
                                            @if (session('voucher_success'))
                                                <div
                                                    class="alert alert-success p-2 mb-2 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <i class="fas fa-check-circle me-2"></i>
                                                        {{ session('voucher_success') }}
                                                    </div>
                                                    <a href="{{ route('cart.removeVoucher') }}"
                                                        class="btn btn-sm btn-outline-danger">
                                                        Remove
                                                    </a>
                                                </div>
                                        ...
                                        <small class="text-muted">Available vouchers: CHILLBRO (min Rp200,000), COOLMAN,
                                            GOODDAY</small>
                                    </div>
                                    ...
                                    <div class="border-top pt-3">
                                        ...
                                        <form id="checkout-form" action="{{ route('checkout.form') }}" method="POST">
                                            ...
                                            <input type="hidden" name="selected_items" id="selected-items"
                                                value="{{ implode(',', session('selected_items', [])) }}">
