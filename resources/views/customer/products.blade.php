                        ...
                        <div id="customAlertContainer" class="w-100" style="max-width: 300px;">
                            @if (session('success'))
                                <div id="successAlertServer"
                                    class="alert alert-success alert-dismissible fade show shadow-sm mb-0" role="alert"
                        ...
                        @foreach ($products as $product)
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div
                                    ...
                                    <form
                                        action="{{ in_array($product->products_id ?? $product['id'], $wishlistProductIds) ? route('wishlist.remove', ['productId' => $product->products_id ?? $product['id']]) : route('wishlist.add', ['productId' => $product->products_id ?? $product['id']]) }}"
                                    ...
                                    <div class="card-body px-4 pb-4 d-flex flex-column">
                                        ...
                                        <form action="{{ route('cart.add', ['productId' => $product->products_id]) }}"
                                            method="POST" class="mt-auto add-to-cart-form">
                                            @csrf
