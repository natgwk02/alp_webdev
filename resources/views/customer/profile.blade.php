        ...
        <div class="col-md-3 mb-4">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    <img src="/assets/profile.png" class="rounded-circle mb-3" width="120" height="120" alt="Profile Photo">
                    <h5 class="card-title">
                        @if (Auth::check())
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-center mb-4">
                        <img src="/assets/profile.png" class="rounded-circle shadow" width="120" height="120" alt="Profile Photo">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    id="users_name"
                                    name="users_name"
                                    value="{{ old('users_name', Auth::user()->users_name) }}"
                                    required>
                                @error('users_name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel"
                                    class="form-control @error('users_phone') is-invalid @enderror"
                                    id="users_phone"
                                    name="users_phone"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    class="form-control @error('users_address') is-invalid @enderror"
                                    id="users_address"
                                    name="users_address"
