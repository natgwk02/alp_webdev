                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                       ...
                                       id="name"
                                       name="name"
                                       value="{{ old('name', Auth::user()->users_name) }}" {{-- Always safe here because middleware 'auth' is active --}}
                                       required>
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email"
                                       ...
                                       id="email"
                                       name="email"
                                       value="{{ old('email', Auth::user()->users_email) }}"
                                       required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
